+++
title = "RECNO: a recno-style table access method for PostgreSQL"
date = "2026-11-30"
draft = true
description = "UNDO-backed in-place updates, integrated overflow pages, no tuple-by-tuple MVCC explosion."
[taxonomies]
tags = ["postgres","postgres-wiki","table-am","storage","series:postgres-wiki"]
+++
...
- `~/Desktop/_/RECNO-Table-Access-Method.mediawiki` — the Wiki page itself, my draft.
- <https://wiki.postgresql.org/wiki/RECNO_Table_Access_Method> — once it's published.
