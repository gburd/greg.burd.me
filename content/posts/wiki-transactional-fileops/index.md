+++
title = "transactional FILEOPS: 13 filesystem operations that respect ROLLBACK"
date = "2026-12-07"
draft = true
description = "CREATE, DELETE, RENAME, WRITE, and friends as crash-safe, WAL-logged transactional operations."
[taxonomies]
tags = ["postgres","postgres-wiki","fileops","wal","undo","series:postgres-wiki"]
+++
...
- `~/Desktop/_/Transactional-FILEOPS.mediawiki` — the Wiki page itself, my draft.
- <https://wiki.postgresql.org/wiki/Transactional_File_Operations> — once it's published.
