+++
title = "left-right lock (LRLock): wait-free reads in PostgreSQL"
date = "2026-11-09"
draft = true
description = "Two copies, an atomic epoch counter, a pointer load — readers never block. The cost is two copies."
[taxonomies]
tags = ["postgres","postgres-wiki","concurrency","lock-free","series:postgres-wiki"]
+++
...
- `~/Desktop/_/Left-Right-Lock.mediawiki` — the Wiki page itself, my draft.
- <https://wiki.postgresql.org/wiki/Left-Right_Lock> — once it's published.
